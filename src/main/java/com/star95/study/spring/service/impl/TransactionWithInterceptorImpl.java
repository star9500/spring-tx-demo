 ...
 * @date 2019/1/24
 */
@Component("withInterceptorService")
public class TransactionWithInterceptorImpl implements UserBalanceService {
    @Autowired()
